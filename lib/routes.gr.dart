...
import 'package:ava/features/address/models/address.dart' as _i8;
...
abstract class $AppRouter extends _i7.RootStackRouter {
  ...
  final Map<String, _i7.PageFactory> pagesMap = {
    ...
    AddressFormRoute.name: (routeData) {
      ...
      return _i7.AutoRoutePage<_i8.AddressData>(
        routeData: routeData,
...
class AddressFormRoute extends _i7.PageRouteInfo<AddressFormRouteArgs> {
  AddressFormRoute({
    _i9.Key? key,
    _i8.AddressData? data,
  ...
  static const _i7.PageInfo<AddressFormRouteArgs> page =
      _i7.PageInfo<AddressFormRouteArgs>(name);
}
...
class AddressListRoute extends _i7.PageRouteInfo<void> {
  const AddressListRoute({List<_i7.PageRouteInfo>? children})
      : super(
...
class AddressFlowRoute extends _i7.PageRouteInfo<void> {
  const AddressFlowRoute({List<_i7.PageRouteInfo>? children})
      : super(
